...
class SandshrewViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        if let url = NSURL(string: "https://pokeapi.co/media/img/27.png") {
    ...
    @IBAction func submitAnswer(sender: UIButton) {
        ...
        if someText != currentEvolution {
            ...
            print("correct")
            self.tryAgain.text = "Good Job! On to level 4!"
    ...
    func getPokemon() {
        let url = NSURL(string: "https://pokeapi.co/api/v2/evolution-chain/11")!
