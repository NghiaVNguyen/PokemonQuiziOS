...
class SlowpokeViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        if let url = NSURL(string: "https://pokeapi.co/media/img/79.png") {
    ...
    @IBAction func submitAnswer(sender: UIButton) {
        ...
        if someText != currentEvolution {
            ...
            print("correct")
            self.tryAgain.text = "Good Job! Game Over!"
    ...
    func getPokemon() {
        let url = NSURL(string: "https://pokeapi.co/api/v2/evolution-chain/33")!
