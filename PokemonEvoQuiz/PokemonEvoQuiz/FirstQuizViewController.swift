...
class FirstQuizViewController: UIViewController{
    ...
    override func viewDidLoad() {
        ...
        if let url = NSURL(string: "https://pokeapi.co/media/img/4.png") {
    ...
    @IBAction func submitAnswer(sender: UIButton) {
        ...
        if someText != currentEvolution {
            ...
            print("correct")
            self.tryAgain.text = "Good Job! On to level 2!"
    ...
    func getPokemon() {
        let url = NSURL(string: "https://pokeapi.co/api/v2/evolution-chain/2")!
